...
import Edit_invoice from "./pages/Edit_invoice";


import DailyOPDReport from "./pages/Manage Reports/DailyOPDReport/DailyOPDReport";
import BirthdayAlert from "./pages/Manage Reports/BirthdayAlert/BirthdayAlert";
import BillingReport from "./pages/Manage Reports/BillingReport/BillingReport";
import EnquiryConversation from "./pages/Manage Reports/EnquiryConversion/EnquiryConversion";
import EnquiryData from "./pages/Manage Reports/EnquiryData/EnquiryData";
import OPDCollectionReport from "./pages/Manage Reports/OPDCollectionReport/OPDCollectionReport";
import PharmacyCollectionReport from "./pages/Manage Reports/PharmacyCollectionReport/PharmacyCollectionReport";
import IPDCollectionReport from "./pages/Manage Reports/IPDCollectionReport/IPDCollectionReport";
import RefferenceReport from "./pages/Manage Reports/RefferenceReport/RefferenceReport";
import ConditionWiseReport from "./pages/Manage Reports/ConditionWiseReport/ConditionWiseReport"; 
import SxConversionReport from "./pages/Manage Reports/SxConversionReport/SxConversionReport";
import IPDDueReport from "./pages/Manage Reports/IPDDueReport/IPDDueReport";
import InsuranceDueReport from "./pages/Manage Reports/InsuranceDueReport/InsuranceDueReport";
import OPDIPDCollection from "./pages/Manage Reports/OPDIPDCollection/OPDIPDCollection";
import OPDIPDCollGraph from "./pages/Manage Reports/OPDIPDCollGraph/OPDIPDCollGraph";
import OPDReceiptsReport from "./pages/Manage Reports/OPDReceiptsReport/OPDReceiptsReport";
import AppointmentConversion from "./pages/Manage Reports/AppointmentConversion/AppointmentConversion";
    ...
    return (
      <>
        ...
        <Routes>
          ...
          <Route exact path="/all-patient" element={<All_patient />} />
          ...
          <Route path="/edit-invoice/:invoice_id" element={<Edit_invoice />} />
          ...
          <Route exact path="/enquiryConversation"element={<EnquiryConversation/>}/>
          <Route exact path="/enquiryData"element={<EnquiryData/>}/>
          <Route exact path="/oPDCollectionReport"element={<OPDCollectionReport/>}/>
          <Route exact path="/pharmacyCollectionReport"element={<PharmacyCollectionReport/>}/>
          <Route exact path="/iPDCollectionReport"element={<IPDCollectionReport/>}/>
          <Route exact path="/refferenceReport"element={<RefferenceReport/>}/>
          <Route exact path="/conditionWiseReport"element={<ConditionWiseReport/>}/>
          <Route exact path="/sxConversionReport"element={<SxConversionReport/>}/>
          <Route exact path="/iPDDueReport"element={<IPDDueReport/>}/>
          <Route exact path="/insuranceDueReport"element={<InsuranceDueReport/>}/>
          <Route exact path="/oPDIPDCollection"element={<OPDIPDCollection/>}/>
          <Route exact path="/oPDIPDCollGraph"element={<OPDIPDCollGraph/>}/>
          <Route exact path="/oPDReceiptsReport"element={<OPDReceiptsReport/>}/>
          <Route exact path="/appointmentConversion"element={<AppointmentConversion/>}/>
