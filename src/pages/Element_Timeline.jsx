...
export default function Element_Timeline() {
  return (
    <>
                                ...
                                <Card>
                                    <Card.Body>
                                        <div className="timeline">
                                            <div className="timeline-grid left">
                                                <div className="icon-wrap">
                                                    <img className="img-fluid" src={IMAGE_URLS['avtar/1.jpg']}  />
                                                </div>
                                                <div className="timeline-content">
                                                    ...
                                                    <Link className="btn btn-md btn-primary" href="#!">Read More</Link>
                                                </div>
                                            </div>
                                            <div className="timeline-grid right">
                                                <div className="icon-wrap">
                                                    <img className="img-fluid" src={IMAGE_URLS['avtar/1.jpg']}  />
                                                </div>
                                                <div className="timeline-content">
